...
def _planner_should_skip_tick(target: dict[str, Any]) -> tuple[bool, str | None, int]:
    unresolved = _planner_unresolved_actions(target)
    unresolved_count = len(unresolved)
    if unresolved_count > PLANNER_MAX_UNRESOLVED_ACTIONS:
        return True, f"Planner tick skipped: unresolved action cap exceeded ({unresolved_count}>{PLANNER_MAX_UNRESOLVED_ACTIONS}).", unresolved_count
